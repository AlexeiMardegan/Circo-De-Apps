...
namespace AppPessoa
{
    class Pessoa
    {
        ...
        SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Aluno\\source\\repos\\AppPessoa\\DbPessoa.mdf;Integrated Security=True");
